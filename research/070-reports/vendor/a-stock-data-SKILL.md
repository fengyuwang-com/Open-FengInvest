> **[FengInvest vendor 归档说明]**
> - 来源 URL: https://raw.githubusercontent.com/simonlin1212/a-stock-data/main/SKILL.md
> - 项目主页: https://github.com/simonlin1212/a-stock-data
> - 版本: V3.7.1（从文件内容确认，2026-08-20 后缀路由修复版）
> - License: Apache-2.0
> - 作者: Simon 林（X [@linsizhen](https://x.com/linsizhen)，simonlin0423@gmail.com）
> - 本机下载日期: 2026-08-24（直连 raw.githubusercontent.com 下载成功）
> - 已抽取端点见 `tools/fengastock.py`（第一批：valuation-hist / ipo-date / sw-industry / adj-factor / quote / macro；第二批 best-effort：lhb / lhb-market / limit-pool / unlock / margin / moneyflow）。抽取时保留了上游防坑逻辑与关键注释。
